...
- **Admin analytics:** private dashboard at `/admin/` (not linked from the public site). Sign in with email + password using an account on the `app_admins` allowlist in Supabase (`jeroenhuitema2006@gmail.com`, etc.).
- **Creator affiliates:** landing page at `/c/?ref=CODE`. Admin dashboard at `/admin/creators/`.
